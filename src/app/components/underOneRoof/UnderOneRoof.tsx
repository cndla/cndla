    ...
    const data = [
        {
            id: 1,
            icon: <SvgEngagement />,
            text: t('underRoof-list-firstElement-paragraph'),
        },
        {
            id: 2,
            icon: <BranIdentity />,
            text: t('underRoof-list-secondElement-paragraph'),
        },
        {
            id: 3,
            icon: <Performance />,
            text: t('underRoof-list-thirdElement-paragraph'),
        },
        {
            id: 4,
            icon: <Audiovisual />,
            text: t('underRoof-list-fourthElement-paragraph'),
        },
        {
            id: 5,
            icon: <BrandExperience />,
            text: t('underRoof-list-fithElement-paragraph'),
        },
    ];
    const Hr = () => (
        <motion.div
        ...
        >
            <div className="grid justify-center h-full grid-cols-6 grid-rows-4 m-auto sm:w-11/12">
                <div className="col-span-6 text-2xl font-bold md:col-span-2 2xl:text-5xl lg:text-4xl">
                    <p className="">{t('underRoof-firstLine-paragraph')}</p>
                    <p className="">-</p>
                </div>
                    ...
                    {data.map((item) => (
                        ...
                        >
                            <div className="flex items-center justify-start gap-6 ">
                                <span className="w-11 aspect-square">
                                    {item.icon}
                                </span>
                                {item.text}
                            </div>
                ...
                <div className="col-span-6 row-start-6 pt-8 md:col-span-2 md:row-start-6 ">
                    <p className="text-xl 2xl:text-4xl lg:text-2xl text-nowrap">
                        {t('underRoof-secondLine-paragraph')} <br />{' '}
                        {t('underRoof-thirdLine-paragraph')}
                    </p>
                </div>
            </div>
        </section>
