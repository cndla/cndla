                ...
                <div className="flex flex-col w-10/12 gap-20 p-5 m-auto text-4xl md:text-5xl">
                    <div className="m-auto font-bold ">
                        <div className="flex px-4 py-1 text-base border border-black rounded-full w-fit">
                            {t('proud-first-button')}
                        </div>
                        <p className="mt-4 ">
                            {t('proud-firstLine-paragraph')}
                        </p>
                        <p className="flex items-end ">
                            - {t('proud-secondLine-paragraph')}{' '}
                            <span className="text-3xl font-normal ">✽</span>
                        </p>
                    </div>
                    <div className="text-xl md:text-2xl">
                        <div className="text-justify ">
                            {t('proud-thirdLine-paragraph')}{' '}
                        </div>
                        <p className="flex justify-between text-xl">
                            ✽
                            <motion.span
                                className="text-xl md:text-2xl"
                                whileInView={{ marginRight: ['10%', 0] }}
                                transition={{
                                    repeat: Infinity,
                                    duration: 3,
                                    repeatType: 'reverse',
        ...
        >
            <div className="flex flex-col items-center justify-center m-auto overflow-hidden lg:w-10/12">
                <div className="font-bold xl:text-8xl lg:text-7xl">
                    <Logo text={t('proud-first-button')} />
                    <p className="">{t('proud-firstLine-paragraph')}</p>
                    ...
                    >
                        ...
                        ></motion.div>
                        <p>{t('proud-sixthLine-paragraph')}</p>
                        <p>{t('proud-seventhLine-paragraph')}</p>
                        <p>{t('proud-eighthLine-paragraph')}</p>
                    </motion.div>
                    <div className="flex items-center justify-between text-3xl font-normal">
                        <p>
                            {t('proud-tenthLine-paragraph')}{' '}
                            {t('proud-fourthLine-paragraph')}
                        </p>
